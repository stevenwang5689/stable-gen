      ...
      <fragment>
        <Container style={{ maxHeight: 800, overflow: "auto" }}>
          ...
          <p className="content-body">
            ...
            stable configuration which the monomers will bind. This is
            essentially "CAD" for monomers. The representation of binding sites,
            monomers, and polymers that we use is called a Thermodynamic Binding
            Network.
          </p>
          <br />
          ...
          <div className="content-div">
            <p className="content-body">
              The Thermodynamic Binding Network (TBN) model is an effective way
              to represent chemical systems in a standardized format for
              modeling and simulation. A TBN is composed of individual monomers
              that have one or more binding sites that can bind with the binding
              sites of other monomers. TBN's have two key properties:
            </p>
            <figure className="content-figure" vertical-align="middle">
              ...
              />
              <figcaption vertical-align="bottom" className="content-caption">
